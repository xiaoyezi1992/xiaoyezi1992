...
# 调整特殊商户简称
detail.loc[detail.loc[:, '商户简称'] == '（360借条1）五矿国际信托有限公司', '商户简称'] = '（360借条）五矿国际信托有限公司'
detail.loc[detail.loc[:, '商户简称'] == '（360借条2）五矿国际信托有限公司', '商户简称'] = '（360借条）五矿国际信托有限公司'
detail.loc[detail.loc[:, '商户简称'] == '中国民生银行股份有限公司信用卡中心', '商户简称'] = '民生银行信用卡中心'
detail.loc[detail.loc[:, '商户简称'] == '实时还款', '商户简称'] = '浦东发展银行信用卡中心'
detail.loc[detail.loc[:, '商户简称'] == '辽宁自贸试验区（营口片区）桔子数字科技有限公司（协议支付）', '商户简称'] = '北京桔子分期电子商务有限公司'  # 20210125更新
detail.loc[detail.loc[:, '商户简称'] == '平安银行股份有限公司信用卡中心1', '商户简称'] = '平安银行信用卡中心'  # 20210401
detail.loc[detail.loc[:, '商户简称'] == '平安银行股份有限公司信用卡中心2', '商户简称'] = '平安银行信用卡中心'  # 20210401
# 增加剔税金额
